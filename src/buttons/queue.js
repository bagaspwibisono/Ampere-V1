...
module.exports = async ({ client, inter, queue }) => { 
    ...
    if (!queue.tracks.toArray()[0]) return  inter.editReply({ content: `Tidak ada musik dalam antrian ini ${inter.member}... coba lagi? ❌`, ephemeral: true });
        ...
        .setTimestamp()
        .setFooter({ text: 'Di mana kata-kata gagal, musik berbicara', iconURL: inter.member.avatarURL({ dynamic: true })})
